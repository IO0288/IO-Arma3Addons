...
with uiNamespace do {
	SLTScriptDisplayName = "Team Map Icons";
};
			...
			with uiNamespace do
			{
				...
				TMI_fnc_mapTrailTick = {
					...
					private _updatedTrails = TMIAllMapTrails;
					{
						...
						if (_timeLeft <= 0) then {
							_updatedTrails deleteAt _forEachIndex;
						};
				...
				TMI_fnc_mapTrailDraw = {
					{
						...
						private _iconFile = if [
							"\a3\ui_f_curator\data\cfgcurator\entity_selected_ca.paa",
